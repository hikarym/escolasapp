...
export class CustomData extends Subject<CompleterItem[]> implements CompleterData {
 ...
 public search(term: string): void {
    /* 'http://172.16.1.32:3005/' */
    console.log('href:' + location.href);
    const url_aplited_array = location.href.split('/');
    const URL_BASE = url_aplited_array[0] + '//' + url_aplited_array[2];
    console.log('host:' + URL_BASE);

    term = this.removeDiacritics(term);
    this.http.get(URL_BASE + '/school/search?text=' + term )
      .map((res: Response) => {
  ...
  public convertToItem(data: any): CompleterItem {
    ...
    return {
      ...
      originalObject: data,
      image: '../../../../assets/images/marcador_school_default.png',
    } as CompleterItem;
  }
